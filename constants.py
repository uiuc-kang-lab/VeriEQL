...
Not = lambda *args: Z3_Not(*args, Z3_CONTEXT)
If = lambda a, b, c: Z3_If(a, b, c, Z3_CONTEXT)
Sum = lambda *args: Z3_Sum(*args)
And = lambda *args: Z3_And(*args, Z3_CONTEXT)
Or = lambda *args: Z3_Or(*args, Z3_CONTEXT)
Implies = lambda a, b: Z3_Implies(a, b, Z3_CONTEXT)
